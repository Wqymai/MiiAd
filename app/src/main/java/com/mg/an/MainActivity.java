...
//        Log.i("TAG", "i="+MiiLocalStrEncrypt.enCodeStringToString("9079537218417626401",LocalKeyConstants.LOCAL_GDT));
        ...
        openInterstitial1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new MiiFixedInterstitialAD(MainActivity.this,Constants.APPID,Constants.InterteristalPosID,false, new MiiADListener() {
                    @Override
        ...
        openInterstitial2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new MiiFixedInterstitialAD(MainActivity.this,Constants.APPID,Constants.InterteristalPosID,true, new MiiADListener() {
                    @Override
                    public void onMiiNoAD(int errCode) {
